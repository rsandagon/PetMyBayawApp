...
declare module PIXI {
    ...
    export class DisplayObject extends EventEmitter implements interaction.InteractiveTarget {
        ...
        //draggable
        draggable(name,value);
        droppable(name,value);
    ...
    export class DragAndDropManager{
        ...
        boundTick():void;
        clear():void;
        collect(child:PIXI.DisplayObject):void;
        onDrag(item,mouse):void;
        onDragStart(item,mouse):void;
        onDrop(item,mouse):void;
        onMouseDown(mouse):void;
        onMouseUp(mouse):void;
        onMouseUpOutside(mouse):void;
        onMouseMove(mouse):void;


        stop(item,mouse):void;

        tick():void;
        closestSort(a,b):any;
        destroyHelperSprite(item):void;
        intersect(item, mouse, droppable, currBounds):any;
